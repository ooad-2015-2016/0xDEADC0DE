...
namespace fleet_tracker.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.TypeID = new SelectList(db.VehicleTypes, "ID", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,Name,TypeID,RegistrationNumber,ChassisNumber,GroupID")] Vehicle vehicle)
        {
            ...
            ViewBag.GroupID = new SelectList(db.Groups, "ID", "Name", vehicle.GroupID);
            ViewBag.TypeID = new SelectList(db.VehicleTypes, "ID", "Name", vehicle.TypeID);
            return View(vehicle);
        }
